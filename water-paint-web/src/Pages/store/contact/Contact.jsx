...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm('service_oqq9cyk', 'template_q3rzhze', form.current, 'iTUEF4rNsbNAx4nXM').then(
            (result) => {
            ...
            <section id="contact-section">
                ...
                <div className="contact-wrapper">
                    <form ref={form} onSubmit={sendEmail}>
                        <div className="mb-3 fs-3 text-center text-uppercase">Gửi ý kiến</div>
                        <div className="mb-3">
                            <div className="d-flex justify-content-between">
                                <label htmlFor="email" className="form-label">
                                    Email
                                </label>
                                <span className="text-secondary fst-italic fs-6">(Bắt buộc)</span>
                            </div>
                        ...
                        <div className="mb-3">
                            ...
                            <textarea className="form-control" name="content" id="content" rows="8" required></textarea>
                        </div>
                    ...
                    <div className="direct-contact-container">
                        ...
                        <ul className="social-media-list">
                            <li>
                                <a href="mailto:2014508@dlu.edu.vn" className="contact-icon">
                                    <FontAwesomeIcon icon={faEnvelope} />
                                </a>
                            </li>
                            <li>
                                <a
                                    href="https://github.com/RyunVu"
                                    target="_blank"
                                    rel="noreferrer"
                        ...
                        <div className="copyright">&copy; Store</div>
                    </div>
                </div>
            </section>
